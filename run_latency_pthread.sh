...
python_script=/home/sdp/xiaobing/RunningScript/resnet50_test_pthread.py

DNNL_VERBOSE=0 numactl --physcpubind=56-111 --membind=1 $python_exe -u $python_script 2>&1 | tee pthread.log
