...
sleep 3
python_exe=python
python_script=resnet50_test.py
...
#DNNL_VERBOSE1 numactl --physcpubind=0-27 --membind=0 /home/sdp/miniconda3/envs/xiaobing-debug/bin/python -u /home/sdp/xiaobing/test/resnet50_test_op.py 2>&1 | tee verbose.log
...
DNNL_VERBOSE=1 numactl --physcpubind=0-55 --membind=0 $python_exe -u $python_script 2>&1 | tee origin.log
